...
export const editProgrammbs = (redirect) => {
    return (dispatch, getState) => {
        ...
        console.log(reduxState.form.programmbs.values.paperwork4);
        console.log(JSON.stringify(reduxState.form.programmbs.values.paperwork4));
        ...
        urlencoded.append("paperwork3", reduxState.form.programmbs.values.paperwork3 !== undefined ? JSON.stringify(reduxState.form.programmbs.values.paperwork3) : "");
        ...
        urlencoded.append("quality_g8", reduxState.form.programmbs.values.quality_g8 !== undefined ? reduxState.form.programmbs.values.quality_g8 : "");
