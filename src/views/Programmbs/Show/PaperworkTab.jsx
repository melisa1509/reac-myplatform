          ...
          <CardBody>
            ...
            <table className={classes.borderSpacing} id="table_paperwork4">
              <thead>
                ...
                <tr>
                  <th className={classes.textCenter + " "+ classes.tdTable + " "+ classes.verticalCenter } style={{ width: '15%' }}><h7 className="td-bold">th.paperwork4_date</h7></th>
                  <th className={classes.textCenter + " "+ classes.tdTable + " "+ classes.verticalCenter }><h7 className="td-bold">th.paperwork4_description</h7></th>
                  <th className={classes.textCenter + " "+ classes.tdTable + " "+ classes.verticalCenter }><h7 className="td-bold">th.paperwork4_expenses</h7></th>
                  <th className={classes.textCenter + " "+ classes.tdTable + " "+ classes.verticalCenter }><h7 className="td-bold">th.paperwork4_income</h7></th>
                  <th className={classes.textCenter + " "+ classes.tdTable + " "+ classes.verticalCenter }><h7 className="td-bold">th.paperwork4_balance</h7></th>
                </tr>
              </thead>
              <tbody>
                <tr>
                  <td className={classes.tdBackgroundColor + " "+ classes.tdTable + " "+ classes.verticalCenter } colSpan={4}><h7 >label.initial_capital</h7></td>
