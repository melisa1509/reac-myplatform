...
class NewForm extends React.Component {
    ...
    render() {
        const { classes, errorRequired, show_grant, successfull_new, active_user, grant_deadline, successful_send, form_values } = this.props;
        let { t } = this.props;  
        ...
        return (
          <GridContainer justify="center">
            ...
            <GridItem xs={12} sm={12} md={11}>
              ...
              <br/>
              <center><InfoBold><h4 className={classes.cardTitleCenter} >{form_values.question12}</h4></InfoBold></center>
              <GridContainer >
