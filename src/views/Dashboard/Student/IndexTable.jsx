  ...
  render() {
    ...
    return (
      <GridContainer>
        ...
        <Link to={dashboard_student.progressMbs.state === "new" ? "/programmbs/new" : "/programmbs/edit/plan/" + dashboard_student.progressMbs.id} className={classes.dropdownLink} >
          <Card>
        ...
        <GridItem xs={6} sm={6} md={3} lg={3}>
        <Link to={dashboard_student.progressMbs.state === "new" ? "/programmbs/new" : "/programmbs/edit/product/" + dashboard_student.progressMbs.id} className={classes.dropdownLink} >
          <Card>
        ...
        <GridItem xs={6} sm={6} md={3} lg={3}>
        <Link to={dashboard_student.progressMbs.state === "new" ? "/programmbs/new" : "/programmbs/edit/process/" + dashboard_student.progressMbs.id} className={classes.dropdownLink} >
          <Card>
        ...
        <GridItem xs={6} sm={6} md={3} lg={3}>
        <Link to={dashboard_student.progressMbs.state === "new" ? "/programmbs/new" : "/programmbs/edit/price/" + dashboard_student.progressMbs.id} className={classes.dropdownLink} >
          <Card>
        ...
        <GridItem xs={6} sm={6} md={3} lg={3}>
        <Link to={dashboard_student.progressMbs.state === "new" ? "/programmbs/new" : "/programmbs/edit/promotion/" + dashboard_student.progressMbs.id} className={classes.dropdownLink} >
          <Card>
            <CardHeader color="danger" stats icon>
              <CardIcon color="danger">
        ...
        <GridItem xs={6} sm={6} md={3} lg={3}>
        <Link to={dashboard_student.progressMbs.state === "new" ? "/programmbs/new" : "/programmbs/edit/paperwork/" + dashboard_student.progressMbs.id} className={classes.dropdownLink} >
          <Card>
            <CardHeader color="info" stats icon>
              <CardIcon color="info">
                <Icon>file_copy</Icon>
        ...
        <GridItem xs={6} sm={6} md={3} lg={3}>
        <Link to={dashboard_student.progressMbs.state === "new" ? "/programmbs/new" : "/programmbs/edit/quality/" + dashboard_student.progressMbs.id} className={classes.dropdownLink} >
          <Card>
            <CardHeader color="warning" stats icon>
              <CardIcon color="warning">
        ...
        <GridItem xs={6} sm={6} md={3} lg={3}>
        <Link to={dashboard_student.progressMbs.state === "new" ? "/programmbs/new" : "/programmbs/edit/service/" + dashboard_student.progressMbs.id} className={classes.dropdownLink} >
          <Card>
            <CardHeader color="success" stats icon>
              <CardIcon color="success">
                <Icon>pan_tool</Icon>
